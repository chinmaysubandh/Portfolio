          ...
          <div className='flex flex-wrap  '>
              <div className='w-full lg:w-1/2 flex items-center max-lg:justify-center'>
                  <div className='flex flex-col max-lg:items-center  justify-between gap-2 '>
                      ...
                      <h1 className=' text-3xl lg:text-5xl font-extrabold bg-gradient-to-r from-pink-400 via-slate-500 to-purple-700 bg-clip-text py-1.5
                       tracking-tight text-transparent'>Chinmay Subandh.</h1>

                      <p className='text-sm font-sans ps-1 max-sm:text-center text-rose-400 flex justify-start  items-center'>&#10084;Building fast, clean, and user-first web experiences......</p>
