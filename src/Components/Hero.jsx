                       ...
                       tracking-tight text-transparent'>Chinmay Subandh.</motion.h1>
                        ...
                        <motion.div
                            ...
                            <motion.button
                                ...
                                className='px-4 py-2 bg-orange-600 hover:bg-orange-700 rounded-3xl hover:scale-105 text-white ease-in-out duration-600'>Contact Me</motion.button>
                            <motion.button
                                
                                className='px-4 py-2 bg-transparent rounded-3xl hover:scale-105 text-white border border-stone-500 ease-in-out duration-600'>Download Resume</motion.button>
                        </motion.div>
